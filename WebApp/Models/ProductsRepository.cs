    ...
    public class ProductsRepository
    {
            ...
            else
            {
                if(_products !=null && _products.Count > 0)
                {
                    _products.ForEach(x =>
                    {
                        ...
                        {
                            x.Category = CategoriesInMemoryRepository.GetCategoryById(x.CategoryId.Value);
        ...
        public static Product? GetProductById(int productId, bool loadCategory =false)
        {
            ...
            if (product != null)
            {
                ...
                {
                    prod.Category=CategoriesInMemoryRepository.GetCategoryById(prod.CategoryId.Value);
                }
                return prod;
            }
